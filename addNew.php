                    ...
                    <div class="col-md-6">
                     ...
                     <form action="lib/create.php" method="post">
                        <table class='table table-hover table-responsive table-bordered'>
                           <tr>
                              <td>Student Name</td>
                              <td><input type='text' name='name' class='form-control' placeholder='Student Name' required /></td>
                           </tr>
                           <tr>
                              <td>Email</td>
                           ...
                           <tr>
                              <td>School Name</td>
                              <td><input type='text' name='school_name' class='form-control' placeholder='School Name' required /></td>
                           </tr>
                           <tr>
                              <td></td>
                              <td>
